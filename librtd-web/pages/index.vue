              ...
              <div>
                ...
                >
                  ...
                  <img
                    ...
                    src="https://images.unsplash.com/photo-1550525811-e5869dd03032?ixlib=rb-1.2.1&ixqx=gK3pCdrjLz&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"
                    alt=""
                  />
                </button>
              </div>
            ...
            <section aria-labelledby="section-1-title">
              ...
              <div class="rounded-lg bg-white overflow-hidden shadow">
                <div class="p-6">
                  <!-- Your content -->
                  <h1
                    class="text-2xl font-bold leading-7 text-gray-900 sm:text-2xl"
                  >
                    Input Sequence
                  </h1>
                  <textarea
...
export default Vue.extend({
  ...
  computed: {
    result() {
      try {
        return reverseComplementReturnTimeDistribution(this.inputSequence, 3)
      } catch (error) {
